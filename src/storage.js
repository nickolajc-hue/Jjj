...
// Formater varighed fra minutter → læsbar dansk tekst
...
// Kontroller om en aftale forekommer på en given dato
export function occursOnDate(appt, targetDate) {
  const start = new Date(appt.date);
  const target = new Date(targetDate);
  // Sammenlign kun datoer (ignorer tid)
...
// Næste forekomst-dato fra og med i dag (til visning i lister)
export function nextOccurrence(appt) {
  ...
  // Find næste forekomst fra i dag
